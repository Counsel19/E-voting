...
import { addCandidateValidator } from "../../lib/formValidator";
...
const AddCandidates = () => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    bookImageData.append("file", photo);
    ...
    try {
      ...
      const { url: photoImageUrl } = photoUploadRes.data;
  ...
  const formik = useFormik({
    ...
    validate: addCandidateValidator,
                    ...
                    >
                      ...
                      {allPositions &&
                        allPositions.map((item) => (
                          <option key={item.position} value={item._id}>
                            {item.position}
                          </option>
                        ))}
                    </select>
